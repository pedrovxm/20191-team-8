...
void Dealer::start_menu() {
	...
	if (this->game_cards == true)
	{
		...
		//prisao//
		this->prisao = al_load_bitmap("../assets/img/prisao_icone.png");
		//dinamite//
		this->dinamite = al_load_bitmap("../assets/img/dinamite_icone.png");
		//mira//
		this->mira = al_load_bitmap("../assets/img/mira_icone.png");
		//mustang//
		this->mustang = al_load_bitmap("../assets/img/mustang_icone.png");
